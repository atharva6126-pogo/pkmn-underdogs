...
const u8 gText_DexHoennTitle[] = _("FERRUM DEX");
...
const u8 gText_DexHoennDescription[] = _("FERRUM region's POKéDEX");
...
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. Hollis Vance's POKéDEX rating!\pPROF. VANCE: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. HOllIS VANCE is in trouble!\nRelease a POKéMON and rescue him!");
